...
\subsection{Additional aesthetics features}
The loading screen
the emojis
the created date in settings
pictures in the skill cards
...
\subsection{Saving and deleting a note}
...
users are able to create a new note and carry out their reflection using the question prompts provided for them. This aims to give clear instructions to
...
question. Throughout each of the help button alerts, the example of a communication reflection is used where someone has had to settle a dispute in their 
...
Users can later delete a note by either selecting the edit button, or through swiping a note in the list to the left. This is a native gesture in iOS used
frequently 
...
\subsection{Reflect on personal note-taking statistics}
...
\subsection{Toggle dark/light mode}
