...
Some of the applications studied for this were: Apple's Voice Memos \citep{apple_inc_voice_nodate}, Apple's Notes \citep{apple_inc_notes_nodate}, Google's 
Keep Notes \citep{google_llc_google_nodate} and Collateral \citep{vargas_collateral_nodate}.
...
An iOS application was chosen for GradReflect due to appealing interface design that come with Apple applications. 
COME BACK TO THIS SECTION!!!!!!!!
Swift was chosen as it is the language used to make iOS applications is an intuitive language for developers. To implement this application 
XCode IDE needed to be used on an Apple device due to Apple
