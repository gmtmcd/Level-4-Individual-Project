...
of the application.
\par 
For this evaluation a total of 8 participants were gathered from a convenience sample of students.
\par 
...
anonymity.
\par 
% At times users noted that they struggled to use the simulated phone, however as these are not an evaluation 
% of the app itself and instead on the simulator, we will only include the significant themes related to the 
% application.
% \par 
...
% COME BACK HERE TO ADD THE LIMITATIONS SPECIFIC TO THIS SECTION MAYBE
...
% This bit might need removed but can maybe explain here what they needed to do?
...
% I think this should be moved down into the analysis of the results maybe
% \begin{figure}
%     \centering
%     \includegraphics[width=1.0\linewidth]{images/HeuristicsEvalGraph.svg}    
...
However, 2 of these heuristics, consistency and standards, and error prevention, did not score as highly.
\par 
From this first section of the survey, participants were also able to explain their motivation behind their scorings. 
These open-ended questions were analysed using open axial coding. Codes were generated for each piece of information
from each question and these were grouped together to identify the major themes. 
\par 

% COME BACK TO HERE TO FINISH THE RESULTS OF THIS




\section{Experimental Design} \label{evalExperimentDesign}
