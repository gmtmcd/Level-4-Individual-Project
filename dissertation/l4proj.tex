...
%     \item Must be intuitive and easy to use. An app that is easier for new users is more likely to encourage users to continue
%     to use the app and have an interest in it.
%     \item Encourage the users to want to continue using the app for future uses, users should hopefully find the value in an
%     app similar to this. 
